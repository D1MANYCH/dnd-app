...
| 📜 **719 заклинаний** | Вся база PHB (PH14 + PH24). Поиск, фильтр по классам, управление ячейками, концентрация, ритуалы. |
| 🎲 **3D-кубики** | Физический бросок d20, d100, костей хитов. WebGL, деревянный поднос, история бросков. |
| ⚔️ **Боевая система** | Инициатива (авто d20+ЛОВ), 28+ состояний, спасброски от смерти, трекер партии с союзниками и монстрами из бестиария SRD. |
| 🎒 **Инвентарь и оружие** | Снаряжение, предметы и деньги. Каталог оружия PHB 2014 (37 позиций, цена/вес/владения), связанный с инвентарём. |
| 🎖️ **Черты** | Все 42 черты Книги игрока 2014 с описаниями и владениями от черт. |
...
Текущая: **v3.58.0** (19 июля 2026).

Из недавнего (версии 3.46–3.58): заклинания перестали быть просто справочником — кнопка **«Использовать»** применяет механику. Заговор кастуется без ячейки, уровневое тратит ячейку с выбором уровня; заклинание бросает свой урон или лечение 3D-кубами с учётом апкаста, делает бросок атаки заклинанием (натуральная 1 — промах, 20 — удвоение кубов), вешает баффы на персонажа и дебаффы на цель прямо в боевом трекере, создаёт призванных спутников, ведёт концентрацию и счётчик раундов боя. Механика прописана для более чем 160 заклинаний.

Ранее (3.42–3.45): **светлая тема** доведена до контраста WCAG AA по всем экранам, редизайн фона «Дымка» с настройкой, автопроверки тем в CI. Ещё раньше (3.31–3.33): вкладка **«Бой»** — авто-инициатива, инлайн-HP и монстры из бестиария SRD прямо в бой; **каталог оружия** (37 позиций PHB 2014, связан с инвентарём); **каталог черт** до всех 42 из Книги игрока. Завершена полная сверка с книгами 2014: названия **и механика** умений всех 12 классов и подклассов, 719 заклинаний и магические предметы приведены к официальному переводу.

Полный changelog — [CHANGELOG.md](CHANGELOG.md) или в самом приложении: меню → «📜 История версий».
Что именно менялось в коде — [docs/RELEASES.md](docs/RELEASES.md): коммиты, изменённые файлы и ссылка на полный патч каждой версии.
