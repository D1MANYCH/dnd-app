...
**v2.5.1** (15.04.2026)
- Фикс заклинаний «Призматический поток» и «Туманный шаг»
- Синхронизация changelog (2.3.0–2.5.0)
- Node-раннер автотестов — 122 теста без браузера

**v2.5.0** (15.04.2026)
- Подклассовые выборы (фазы A–G): Воин, Следопыт, Варвар, Чародей, Монах и пассивные подклассы
- Уровневые фильтры опций подклассов
- Тест-ранер (`tests/runner.html`) — 122 автотеста

**v2.4.0** (13.04.2026)
- Интерактивные классовые выборы: стиль боя, маневры, метамагия, пакты/воззвания, экспертиза
- Унифицированный API `ccGetAllChoicesFor`
- Фикс расовых бонусов характеристик

**v2.3.0** (12.04.2026)
- Категоризированные владения: языки, инструменты, доспехи, оружие

**v2.2.0** (11.04.2026)
- Мастер создания персонажа с блокировкой основы
- Расовые черты Человека и бонусы Полуэльфа

**v2.1.0** (10.04.2026)
- Мультиклассирование PHB с требованиями характеристик
- Механические фичи всех 50+ подклассов

**v2.0.0** (09.04.2026)
- Преимущество/Помеха, сопротивления/иммунитеты, бой двумя оружиями, 3D-кубики
