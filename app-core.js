...
function _applyBuildCore(buildId) {
  ...
  if (b.startingSpells) {
    ...
    var _SPELL_ALIASES = {
      ...
      "терновый бич": "терновый кнут",
      "яд-брызги": "ядовитые брызги",
      // ——— ниже: ур.1+ заклинания (будущие партии REQ-5b ещё не переименованы) ———
      "сонливость": "сон",
...
window.resolveSpellByName = (function(){
  var ALIASES = {
    ...
    "сонливость": "сон", "рука мага": "волшебная рука",
    "удар грома": "громовая волна", "стрелы грома": "громовая кара",
    "выработка": "искусство друидов", "смех таши": "жуткий смех таши",
    "насмешка": "злая насмешка", "защита от добра и зла": "защита от зла и добра",
    "охотничья метка": "метка охотника", "снаряд-громовержец": "громовая волна",
    "шиллела": "дубинка", "ложная жизнь": "мнимая жизнь",
