...
function _applyBuildCore(buildId) {
  ...
  if (b.startingSpells) {
    ...
    var _SPELL_ALIASES = {
      ...
      // SPELL-AUDIT-5: имена dnd.su (ур.7–9) → каноничные имена SPELL_DATABASE.
      "радужные брызги": "призматический луч", "призматический поток": "призматический луч",
      "полное превращение": "перевоплощение", "преображение": "перевоплощение",
      "узилище": "силовая клетка", "помутнение разума": "оцепенение"
    };
...
window.resolveSpellByName = (function(){
  var ALIASES = {
    ...
    // SPELL-AUDIT-1: имена заговоров с dnd.su (PH14/PH24) → каноничные имена SPELL_DATABASE.
    "искусство друидов": "друидический знак", "защита от оружия": "защита клинком",
    "злая насмешка": "злобная насмешка", "сообщение": "знаменательное послание",
    "меткий удар": "истинный удар", "брызги кислоты": "кислота брызгами",
    "леденящее прикосновение": "могильный холод", "сотворение пламени": "пламя",
    "пляшущие огоньки": "пляшущие огни", "уход за умирающим": "поддержка умирающего",
    "электрошок": "потрясение", "фокусы": "престидижитация", "терновый кнут": "терновый бич",
    "ядовитые брызги": "яд-брызги", "наставление": "руководство",
    "звездный светлячок": "звёздная искра", "чародейский выброс": "чародейский взрыв",
    // SPELL-AUDIT-2: имена заклинаний dnd.su (ур.1, PH14/PH24) → каноничные имена SPELL_DATABASE.
    "адское возмездие": "адская расплата", "безмолвный образ": "беззвучное изображение",
    "божественное благоволение": "божественная милость", "доспех агатиса": "броня агатиса",
    "ведьмин снаряд": "ведьмин болт", "волна грома": "громовая волна", "скороход": "длинный шаг",
    "палящая кара": "жгучая кара", "чудо-ягоды": "живительная ягода", "добряника": "живительная ягода",
    "невидимое письмо": "иллюзорный текст", "иллюзорные письмена": "иллюзорный текст", "приказ": "команда",
    "псевдожизнь": "мнимая жизнь", "падение перышком": "мягкое падение", "направляющий снаряд": "направляющий болт",
    "невидимый слуга": "незримый слуга", "обнаружение болезней и яда": "обнаружение яда и болезни",
    "обнаружение добра и зла": "обнаружение зла и добра", "огненные ладони": "огненные руки", "огонь фей": "огни фей",
    "очищение пищи и питья": "очищение еды и питья", "тензеров парящий диск": "плавающий диск тенсера",
    "парящий диск тензера": "плавающий диск тенсера", "сигнал тревоги": "сигнализация", "лечащее слово": "слово исцеления",
    "скольжение": "смазка", "намасливание": "смазка", "сотворение или уничтожение воды": "создать или уничтожить воду",
    "усыпление": "сон", "поспешное отступление": "ускоренное отступление", "цветной шарик": "хроматическая сфера",
    "сверкающие брызги": "цветная россыпь", "цветной поток": "цветная россыпь", "гневная кара": "яростная кара",
    "снаряд хаоса": "хаотичный снаряд",
    // SPELL-AUDIT-2: имена заклинаний dnd.su (ур.2, PH14) → каноничные имена SPELL_DATABASE.
    "корона безумия": "венец безумия", "магическое оружие": "волшебное оружие", "волшебные уста": "говорящие уста",
    "почтовое животное": "гонец-животное", "палящий луч": "жгучий луч", "речь златоуста": "завораживание",
    "охраняющая связь": "защитная связь", "отражения": "зеркальное отображение", "область истины": "зона правды",
    "смена обличья": "изменить облик", "мельфова кислотная стрела": "кислотная стрела мельфа", "дубовая кора": "кора дерева",
    "нистулова ложная аура": "магическая аура нистула", "волшебный замок": "магический замок", "молебен лечения": "молитва об исцелении",
    "видение невидимого": "обнаружение невидимости", "пылающий шар": "огненная сфера", "горящий клинок": "огненный клинок",
    "поиск животных или растений": "определение животных или растений", "поиск предмета": "определение предмета", "открывание": "отмычка",
    "бесследное передвижение": "передвижение без следов", "нетленные останки": "покой", "подмога": "помощь",
    "гадание": "предзнаменование", "воображаемая сила": "призрачная сила", "размытый образ": "размытие",
    "раскалённый металл": "раскалить металл", "глухота/слепота": "слепота/глухота", "тьма": "темнота",
    "облако кинжалов": "туча кинжалов", "улучшение характеристики": "усиление способности", "умиротворение": "успокоение эмоций",
    // SPELL-AUDIT-2: имена dnd.su 2024 (ур.2, PH24, ≠ PH14) → каноничные имена.
    ...
    // #310/#360 переименованы «Ледяная буря»→«Метель» (Sleet Storm); dnd.su «Ледяная буря»/«Град» = Ice Storm → наш «Ледяной шторм».
    "град": "ледяной шторм", "ледяная буря": "ледяной шторм",
    "воображаемый убийца": "призрак-убийца", "призрачный убийца": "призрак-убийца",
    ...
    "истинное видение": "истинное зрение", "фальшивый двойник": "обман",
    "ледяная сфера отилюка": "ледяная сфера оттилюка",
    // SPELL-AUDIT-5: имена dnd.su (ур.7–9, PH14/PH24) → каноничные имена SPELL_DATABASE.
    // Prismatic Spray «Радужные брызги» = #610/#632 (наш «Призматический луч»; #611 «Призматический поток» удалён-дубль).
    // Shapechange «Полное превращение»/2024 «Преображение» = #691/#707 (наш «Перевоплощение»).
    // Forcecage «Узилище» = «Силовая клетка»; Befuddlement «Помутнение разума» = #671 «Оцепенение».
    "радужные брызги": "призматический луч", "призматический поток": "призматический луч",
    "полное превращение": "перевоплощение", "преображение": "перевоплощение",
    "узилище": "силовая клетка", "помутнение разума": "оцепенение",
    // SPELL-AUDIT-6: коллизия «Порча» разрешена по канону dnd.su (обе ред.): Bane=«Порча» (id99/id136),
    // Hex=«Сглаз» (id161). Старое имя PH24-Bane «Злой рок» → «Порча» (миграция сохранённых). Divination 2024 dnd.su = «Предсказание».
    "злой рок": "порча", "предсказание": "прорицание",
    ...
    "финал-палец": "перст смерти", "искривление земли": "сдвинуть землю",
