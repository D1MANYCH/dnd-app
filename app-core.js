...
function _applyBuildCore(buildId) {
  ...
  if (b.startingSpells) {
    ...
    var _SPELL_ALIASES = {
      ...
      "оживление": "возрождение", "оживление мертвецов": "восставший труп",
...
window.resolveSpellByName = (function(){
  var ALIASES = {
    ...
    "массовое лечение": "массовое лечение ран",
    ...
    "антимагия": "антимагическое поле", "спайк-грейв": "шипы",
