...
🐛 ритуал длится время накладывания + 10 минут (заклинание на 1 действие — 10 мин, на 1 минуту — 11, на 10 минут — 20, на 1 час — 70); колдун 2014 с «Договором цепи» может сотворить «Поиск фамильяра» ритуалом; на коротком отдыхе у мультикласса кости хитов выбираются по размеру — отдельный счётчик для к10, к8, к6 и т. д., больше оставшихся не выбрать
