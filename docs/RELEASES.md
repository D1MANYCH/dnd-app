...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/e9ee72b4...main) · 15 файлов, +548 −157
...
- `rules.js` +120 −15
- `dev-verify-builds.js` +108 −0
- `index.html` +47 −47
- `app-hp.js` +29 −39
- `tests/rules-cases.js` +64 −0
- `tests/headless.js` +58 −2
- `.github/workflows/pages.yml` +32 −10
- `app-combat.js` +27 −12
- `.github/workflows/claude-code-review.yml` +12 −20
- `.github/workflows/tests.yml` +18 −4
- `data.js` +12 −4
- `app-migrate.js` +12 −0
- `CHANGELOG.md` +6 −1
- `CLAUDE.md` +2 −2
