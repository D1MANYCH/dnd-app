...
<a id="v4.0.4"></a>
## v4.0.4 — 26 сентября 2026

🐛 «Использовать» у заклинаний — подчёркнутым текстом, «Подготовить» — приглушённым текстом вместо залитых чипов; ритуал, бонусы и черты вида, «План» и «Отвязать» у билда — текстом через «·» вместо пилюль; заголовки секций «Мира» — ромб и шрифт с засечками; фильтры журнала — словами без иконок, у строк журнала убраны эмодзи; поиск персонажей плоский в обеих темах; из заголовка окна выбора класса убран эмодзи

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/9cd7b7ad...855ada75) · 9 файлов, +170 −119

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`855ada75`](https://github.com/D1MANYCH/dnd-app/commit/855ada75) v4.0.4: fix(ui): «Использовать» у заклинаний — подчёркнутым текстом, «Подготовить» — приглушённым текстом вместо залитых чипов; ритуал, бонусы и черты вида, «План» и «Отвязать» у билда — текстом через «·» вместо пилюль; заголовки секций «Мира» — ромб и шрифт с засечками; фильтры журнала — словами без иконок, у строк журнала убраны эмодзи; поиск персонажей плоский в обеих темах; из заголовка окна выбора класса убран эмодзи
...
<a id="v4.0.3"></a>
## v4.0.3 — 26 сентября 2026

🐛 тосты без эмодзи — тип отмечен цветным ромбом на нейтральной плашке; единое пустое состояние (иконка, заголовок, подсказка, текстовое действие) в журнале, отряде, прихвостнях и заметках; кнопки удаления в строках — SVG-корзина вместо ✕ и 🗑, у заметок — звезда, карандаш, корзина; из заголовка окна повышения характеристик убран эмодзи

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/38b69fa4...9cd7b7ad) · 13 файлов, +177 −90

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`9cd7b7ad`](https://github.com/D1MANYCH/dnd-app/commit/9cd7b7ad) v4.0.3: fix(ui): тосты без эмодзи — тип отмечен цветным ромбом на нейтральной плашке; единое пустое состояние (иконка, заголовок, подсказка, текстовое действие) в журнале, отряде, прихвостнях и заметках; кнопки удаления в строках — SVG-корзина вместо ✕ и 🗑, у заметок — звезда, карандаш, корзина; из заголовка окна повышения характеристик убран эмодзи

**Файлы (13):**

- `index.html` +46 −46
- `style.css` +38 −5
- `docs/RELEASES.md` +36 −5
- `app-core.js` +16 −2
- `app-notes.js` +5 −11
- `app-party.js` +8 −8
- `data.js` +10 −2
...
<a id="v4.0.2"></a>
## v4.0.2 — 26 сентября 2026

🐛 Короткие формы приведены к одному виду: на телефоне открываются шторкой снизу, на ПК — по центру. Шапка — ромб и заголовок с засечками, у всех окон крестик ✕ в зоне 44px (добавлен в 15 окон, где его не было). Подвал — «Отмена» текстом и одна залитая кнопка: «Сохранить» и «Добавить» больше не красные, красная остаётся только у удаления. Поля в формах плоские с нижней линией в обеих темах. Цели урона и лечения заклинания на «Бое» — плоские строки с ромбом.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/6e5a82e0...38b69fa4) · 10 файлов, +536 −286

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`38b69fa4`](https://github.com/D1MANYCH/dnd-app/commit/38b69fa4) v4.0.2: fix(ui): единый вид коротких форм — шторка/центр, крестик 44px, плоские поля
...
<a id="v4.0.1"></a>
## v4.0.1 — 26 сентября 2026

🐛 Вёрстка: окно «Размен монет» на телефоне открывается в пределах экрана — раньше уходило ниже нижнего края; панель журнала сессии получила размытие фона, как у бокового меню, — текст листа сквозь неё больше не проступает; длинные имена в трекере боя переносятся на вторую строку вместо обрезки многоточием; в форме предмета на экранах до 480 px выбор восстановления зарядов стоит отдельной строкой и не обрезается

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/d5d738d7...6e5a82e0) · 8 файлов, +470 −110

<details><summary>Коммиты и файлы</summary>

**Коммиты (2):**

- [`a31b71bc`](https://github.com/D1MANYCH/dnd-app/commit/a31b71bc) chore(tests): матрица снимков shot-matrix.mjs и починка фикстуры аудита тем
- [`6e5a82e0`](https://github.com/D1MANYCH/dnd-app/commit/6e5a82e0) v4.0.1: fix(ui): размен монет, журнал сессии, имена в трекере боя, форма предмета

**Файлы (8):**

- `tests/shot-matrix.mjs` +308 −0
- `index.html` +91 −91
- `docs/RELEASES.md` +33 −5
- `style.css` +16 −8
- `data.js` +11 −3
- `CHANGELOG.md` +6 −1
- `tests/theme-audit-fixture.html` +4 −1
- `sw.js` +1 −1

</details>

<a id="v4.0.0"></a>
## v4.0.0 — 25 сентября 2026
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/2bb603e9...d5d738d7) · 13 файлов, +175 −114

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`d5d738d7`](https://github.com/D1MANYCH/dnd-app/commit/d5d738d7) v4.0.0: feat(2024): Редакция 2024 открыта для всех
...
- `app-pdf.js` +40 −2
- `docs/RELEASES.md` +36 −5
- `app-settings.js` +3 −26
- `tests/headless.js` +4 −14
- `app-builds.js` +4 −9
- `data.js` +10 −2
- `app-help.js` +11 −0
- `CHANGELOG.md` +6 −1
...
<a id="v3.110.0"></a>
## v3.110.0 — 25 сентября 2026

✨ Мультикласс 2024: требования — 13 в основной характеристике нового и каждого текущего класса по «Книге игрока 2024»; владения при мультиклассе по описаниям классов — воин, паладин и следопыт получают только воинское оружие (без простого), друид — лёгкие доспехи и щиты без средних, колдун — только лёгкие доспехи, монах — ничего; при импорте персонажа с подклассом не из его редакции показывается предупреждение; эпический дар на 19 уровне проверен у всех 12 классов 2024

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/94f2e690...6b1e0289) · 9 файлов, +253 −56

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`6b1e0289`](https://github.com/D1MANYCH/dnd-app/commit/6b1e0289) v3.110.0: feat(2024): Мультикласс 2024 — требования по характеристикам и владения

**Файлы (9):**

- `tests/headless.js` +96 −0
- `index.html` +46 −46
- `docs/RELEASES.md` +32 −5
- `data-2024.js` +32 −1
- `app-io.js` +20 −0
...
<a id="v3.105.0"></a>
## v3.105.0 — 25 сентября 2026

✨ Классы 2024 — Плут и Монах: умения всех 20 уровней по таблицам «Книги игрока 2024», по 4 подкласса на 3 уровне (Вор, Убийца, Мистический ловкач, Душеклинок; Мастер милосердия, Мастер тени, Мастер стихий, Мастер открытой ладони); у плута увеличение характеристик на 4, 8, 10, 12 и 16 уровнях, эпический дар на 19, «Удача» на 20, 2 оружейных приёма, владение воинским оружием с фехтовальным или лёгким свойством, навыки без Выступления; у монаха «Очки духа» по уровню с 2 уровня (восстанавливаются после короткого отдыха), «Необычный метаболизм» раз до долгого отдыха, воинское оружие со свойством лёгкое; кости психической энергии Душеклинка к6→к12

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/92b9c42d...4327effc) · 7 файлов, +361 −72

<details><summary>Коммиты и файлы</summary>

**Коммиты (2):**

- [`dc7c6d6e`](https://github.com/D1MANYCH/dnd-app/commit/dc7c6d6e) chore(docs): v3.104.14 — формулировка записи о ритуалах и костях хитов в истории изменений
- [`4327effc`](https://github.com/D1MANYCH/dnd-app/commit/4327effc) v3.105.0: feat(2024): классы 2024 — Плут и Монах: умения всех 20 уровней по таблицам «Книги игрока 2024», по 4 подкласса на 3 уровне (Вор, Убийца, Мистический ловкач, Душеклинок; Мастер милосердия, Мастер тени, Мастер стихий, Мастер открытой ладони); у плута увеличение характеристик на 4, 8, 10, 12 и 16 уровнях, эпический дар на 19, «Удача» на 20, 2 оружейных приёма, владение воинским оружием с фехтовальным или лёгким свойством, навыки без Выступления; у монаха «Очки духа» по уровню с 2 уровня (восстанавливаются после короткого отдыха), «Необычный метаболизм» раз до долгого отдыха, воинское оружие со свойством лёгкое; кости психической энергии Душеклинка к6→к12

**Файлы (7):**

- `data-2024.js` +171 −12
- `index.html` +46 −46
- `tests/headless.js` +90 −1
- `docs/RELEASES.md` +34 −6
- `data.js` +12 −4
- `CHANGELOG.md` +7 −2
- `sw.js` +1 −1
...
<a id="v3.104.14"></a>
## v3.104.14 — 24 сентября 2026

🐛 ритуал накладывается на 10 минут дольше обычного (заклинание на 1 действие — 10 минут, на 1 минуту — 11, на 10 минут — 20, на 1 час — 70); колдун с «Договором цепи» (редакция 2014) может накладывать «Поиск фамильяра» как ритуал; на коротком отдыхе персонаж с несколькими классами выбирает, какие кости хитов тратить: у каждого размера (к10, к8, к6…) свой счётчик, потратить больше оставшихся нельзя

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/ba10975f...92b9c42d) · 11 файлов, +188 −66

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`92b9c42d`](https://github.com/D1MANYCH/dnd-app/commit/92b9c42d) v3.104.14: fix(rules): ритуал длится время накладывания + 10 минут (заклинание на 1 действие — 10 мин, на 1 минуту — 11, на 10 минут — 20, на 1 час — 70); колдун 2014 с «Договором цепи» может сотворить «Поиск фамильяра» ритуалом; на коротком отдыхе у мультикласса кости хитов выбираются по размеру — отдельный счётчик для к10, к8, к6 и т. д., больше оставшихся не выбрать
...
- `rules.js` +20 −1
- `app-spells.js` +10 −6
- `tests/rules-cases.js` +14 −0
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `tests/headless.js` +7 −0
- `sw.js` +1 −1
- `app-core.js` +1 −0
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/ed850d37...ff75c882) · 14 файлов, +220 −79

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`ff75c882`](https://github.com/D1MANYCH/dnd-app/commit/ff75c882) v3.104.12: fix(2024): редакция 2024 по книге — длинный отдых возвращает все кости хитов и снимает 1 степень истощения без условия «ел и пил» (флажок еды в 2024 не показывается); «Боевой заклинатель» 2024 даёт преимущество на концентрацию, СЛ концентрации не выше 30; «Мастер на все руки» и «Выдающийся атлет» в 2024 не дают бонус к инициативе; «Нанесение ран» PH24 — спасбросок ТЕЛ, половина при успехе; «Божественное оружие» PH24 — +1к8 за каждый уровень ячейки выше 2-го; «Сглаз» PH24 — 4 часа на ячейке 2 уровня; эльф — «Обострённые чувства»; «Дар стойкости» +40 к максимуму хитов; текст черты «Использование двух оружий» по книге; снятие бонуса предыстории возвращает характеристику к исходному значению, если бонус упёрся в 20

**Файлы (14):**

- `index.html` +46 −46
- `docs/RELEASES.md` +37 −5
- `tests/headless.js` +33 −1
- `tests/rules-cases.js` +30 −0
- `app-combat.js` +24 −4
- `rules.js` +12 −5
- `data.js` +11 −2
- `spell-effects.js` +7 −2
- `app-hp.js` +4 −4
- `CHANGELOG.md` +6 −1
- `app-asi.js` +3 −3
- `spells.js` +3 −3
...
<a id="v3.104.11"></a>
## v3.104.11 — 24 сентября 2026

🐛 готовые билды и предметы по книгам — все 36 билдов укладываются в 27 очков покупки (11 билдов было 29–31); прибавки характеристик в плане развития считаются от значения с расовым бонусом, перелёт за 20 уходит во вторую ключевую характеристику, подписи «было→стало» исправлены; чародеи без «Указания» («Луч холода», «Защита от оружия»), следопыт — «Град шипов» вместо «Волны грома», Мистический рыцарь — 2 заговора и 3 заклинания без «Громовой кары», жрец бури — «Чудотворство» вместо «Удара грома», друиды — 2 заговора на 1 уровне; персонаж из билда начинает с полными ХП с учётом расового бонуса ТЕЛ и холмового дварфа; Медальон защиты от яда без настройки; Жезл хранителя договора восстанавливает ячейку действием раз до длинного отдыха; Жезл бдительности — преимущество на Внимательность и инициативу; посохи леса, силы и магов — +2 к атакам заклинаниями, не к Сл; Эльфийская кольчуга — кольчужная рубаха +1 КД; молодой синий дракон — рытьё 20 фт; Specter назван «Спектр»

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/0a53b519...ed850d37) · 11 файлов, +341 −234

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`ed850d37`](https://github.com/D1MANYCH/dnd-app/commit/ed850d37) v3.104.11: fix(builds): готовые билды и предметы по книгам — все 36 билдов укладываются в 27 очков покупки (11 билдов было 29–31); прибавки характеристик в плане развития считаются от значения с расовым бонусом, перелёт за 20 уходит во вторую ключевую характеристику, подписи «было→стало» исправлены; чародеи без «Указания» («Луч холода», «Защита от оружия»), следопыт — «Град шипов» вместо «Волны грома», Мистический рыцарь — 2 заговора и 3 заклинания без «Громовой кары», жрец бури — «Чудотворство» вместо «Удара грома», друиды — 2 заговора на 1 уровне; персонаж из билда начинает с полными ХП с учётом расового бонуса ТЕЛ и холмового дварфа; Медальон защиты от яда без настройки; Жезл хранителя договора восстанавливает ячейку действием раз до длинного отдыха; Жезл бдительности — преимущество на Внимательность и инициативу; посохи леса, силы и магов — +2 к атакам заклинаниями, не к Сл; Эльфийская кольчуга — кольчужная рубаха +1 КД; молодой синий дракон — рытьё 20 фт; Specter назван «Спектр»

**Файлы (11):**

- `character-builds.js` +163 −163
- `index.html` +46 −46
- `tests/headless.js` +49 −0
- `docs/RELEASES.md` +34 −5
- `magic-items.js` +9 −9
- `dev-verify-builds.js` +10 −5
- `data.js` +10 −2
- `app-builds.js` +11 −0
- `CHANGELOG.md` +6 −1
- `monsters-srd.js` +2 −2
...
- `data-2024.js` +10 −1
- `style.css` +9 −1
- `app-proficiencies.js` +5 −3
- `CHANGELOG.md` +6 −1
- `app-inventory.js` +2 −4
- `app-builds.js` +2 −2
- `sw.js` +1 −1
...
<a id="v3.104.3"></a>
## v3.104.3 — 23 сентября 2026

🐛 хиты и кости хитов — максимум ХП считается по каждому классу мультикласса (первый класс — полная кость, остальные — среднее своей кости); ручной максимум ХП сохраняется при загрузке, «Пересчитать» возвращает авто-расчёт; кости хитов учитываются по размеру (у мультикласса тратятся и возвращаются сначала крупные), подпись вида «1к10 + 2к6»; прибавка при повышении уровня больше не уходит в минус с «Крепким»; потраченные кости не возвращаются при правке листа; холмовой дварф +1 ХП за уровень, «Драконья кровь» +1 ХП за уровень чародея; быстрый бросок кости и короткий отдых считают лечение одной формулой (бросок + ТЕЛ, минимум 0), история ХП показывает реальное лечение; временные ХП не ниже 0; схема персонажа 38 (hpMaxManual, hpDiceSpentBy)

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/e9ee72b4...e6ff924b) · 16 файлов, +503 −144

<details><summary>Коммиты и файлы</summary>

**Коммиты (2):**

- [`91050525`](https://github.com/D1MANYCH/dnd-app/commit/91050525) chore(ci): AUD-3 — деплой pages только после зелёного tests, node --check всех js, права и пины экшенов по SHA, проверки законности в verifyAllBuilds
- [`e6ff924b`](https://github.com/D1MANYCH/dnd-app/commit/e6ff924b) v3.104.3: fix(hp): хиты и кости хитов — максимум ХП считается по каждому классу мультикласса (первый класс — полная кость, остальные — среднее своей кости); ручной максимум ХП сохраняется при загрузке, «Пересчитать» возвращает авто-расчёт; кости хитов учитываются по размеру (у мультикласса тратятся и возвращаются сначала крупные), подпись вида «1к10 + 2к6»; прибавка при повышении уровня больше не уходит в минус с «Крепким»; потраченные кости не возвращаются при правке листа; холмовой дварф +1 ХП за уровень, «Драконья кровь» +1 ХП за уровень чародея; быстрый бросок кости и короткий отдых считают лечение одной формулой (бросок + ТЕЛ, минимум 0), история ХП показывает реальное лечение; временные ХП не ниже 0; схема персонажа 38 (hpMaxManual, hpDiceSpentBy)
...
- `index.html` +47 −47
- `app-hp.js` +29 −39
- `tests/rules-cases.js` +64 −0
- `tests/headless.js` +58 −2
- `dev-verify-builds.js` +54 −0
- `docs/RELEASES.md` +41 −5
- `app-combat.js` +27 −12
- `.github/workflows/pages.yml` +16 −5
- `.github/workflows/claude-code-review.yml` +6 −10
- `data.js` +12 −4
- `app-migrate.js` +12 −0
- `.github/workflows/tests.yml` +9 −2
- `CHANGELOG.md` +6 −1
- `CLAUDE.md` +1 −1
- `sw.js` +1 −1
...
- `app-core.js` +83 −8
- `sw.js` +82 −8
- `tests/headless.js` +57 −0
- `docs/RELEASES.md` +37 −5
- `app-party.js` +17 −6
- `app-notes.js` +16 −5
- `tools/check-invariant.js` +21 −0
- `app-dice.js` +14 −5
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `app-migrate.js` +6 −0
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/e4e8bce7...954daaf7) · 15 файлов, +262 −102

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`954daaf7`](https://github.com/D1MANYCH/dnd-app/commit/954daaf7) v3.104.1: fix(import): безопасность импорта персонажа
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/54877db5...e4e8bce7) · 16 файлов, +822 −100

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`e4e8bce7`](https://github.com/D1MANYCH/dnd-app/commit/e4e8bce7) v3.104.0: feat(classes): классы 2024 — Воин и Варвар, подклассы, ресурсы, мастерство оружия, эпический дар
...
<a id="v3.102.0"></a>
## v3.102.0 — 18 сентября 2026

✨ Предыстории 2024 — 16 предысторий PHB 2024 (характеристики, черта происхождения, навыки, инструмент, стартовое снаряжение А/Б), распределение +2/+1 или +1/+1/+1 из характеристик предыстории, черта происхождения выдаётся автоматически и следует за предысторией, своя предыстория (3 характеристики, 2 навыка, черта). Бонус черты «Крепкий» к максимуму хитов больше не теряется при пересчёте.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/3c4ce38c...7e43a300) · 13 файлов, +750 −80

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`7e43a300`](https://github.com/D1MANYCH/dnd-app/commit/7e43a300) v3.102.0: feat(backgrounds): предыстории 2024 — 16 предысторий PHB 2024, характеристики от предыстории, черта происхождения, своя предыстория

**Файлы (13):**

- `app-combat.js` +350 −11
- `tests/headless.js` +145 −0
- `index.html` +48 −46
- `data-2024.js` +79 −2
- `rules.js` +47 −4
- `docs/RELEASES.md` +36 −5
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/ffe6543f...bafcac26) · 16 файлов, +7713 −142

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`bafcac26`](https://github.com/D1MANYCH/dnd-app/commit/bafcac26) v3.99.0: feat(spells): заклинания 2024 — база PH24 391 + prepared-модель по таблицам классов

**Файлы (16):**

- `tests/_spell-book24-index.json` +6138 −0
- `spells.js` +815 −59
- `tools/spell-book24-diff.js` +236 −0
- `tools/spell-book24-extract.py` +159 −0
- `tests/headless.js` +134 −2
- `index.html` +46 −46
- `app-spells.js` +54 −10
- `docs/RELEASES.md` +39 −5
- `data-2024.js` +35 −6
- `spell-effects.js` +27 −1
- `data.js` +12 −3
- `docs/map.md` +6 −6
- `CHANGELOG.md` +6 −1
...
<a id="v3.98.0"></a>
## v3.98.0 — 14 сентября 2026

✨ Замок листа: под замок добавлены правка параметров предметов и оружия и личный каталог оружия (сохранение и удаление); добавление и удаление предметов открыто. При повышении уровня и при увеличении характеристик или взятии черты замок снимается сам — на экране результата и в подсказке предлагается выбрать новые заклинания и умения и снова нажать «Персонаж готов». Справка «Лист» и обучение дополнены шагом «Персонаж готов».

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/3ee2767a...ffe6543f) · 13 файлов, +330 −173

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`ffe6543f`](https://github.com/D1MANYCH/dnd-app/commit/ffe6543f) v3.98.0: feat(sheet): замок листа — снаряжение под замком, авто-снятие при повышении уровня
...
- `style.css` +5 −0
- `app-combat.js` +2 −2
- `app-inventory.js` +3 −1
- `sw.js` +1 −1

</details>

<a id="v3.97.0"></a>
## v3.97.0 — 14 сентября 2026

✨ Замок листа: под замок добавлены заклинательная характеристика, удаление известных заклинаний и взятых черт; кнопки удаления скрыты, пока лист зафиксирован. Ожидающие выборы (подкласс, увеличение характеристик, выборы класса) остаются доступны.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/5fe6c866...3ee2767a) · 10 файлов, +165 −60

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`3ee2767a`](https://github.com/D1MANYCH/dnd-app/commit/3ee2767a) v3.97.0: feat(sheet): замок листа — заклинательная характеристика, удаление заклинаний и черт закрыты до повышения уровня

**Файлы (10):**

- `index.html` +46 −46
- `tests/headless.js` +54 −0
- `docs/RELEASES.md` +33 −5
- `data.js` +11 −3
- `app-combat.js` +7 −4
- `CHANGELOG.md` +6 −1
...
- `app-settings.js` +19 −0
- `style.css` +17 −0
- `data.js` +12 −3
- `app-proficiencies.js` +12 −0
- `app-migrate.js` +7 −0
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
...
<a id="v3.95.1"></a>
## v3.95.1 — 13 сентября 2026

🔧 character-builds.js (200 КБ) грузится лениво через ensureBuilds() — при открытии пикера билдов, гайда, плана, применении билда или сразу на старте, если у персонажа есть buildId; стартовый парсинг меньше на один файл. esc() в журнале приложения экранирует кавычки через escapeHtml().

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/0ec66fb5...2e28b9f4) · 9 файлов, +138 −58

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`2e28b9f4`](https://github.com/D1MANYCH/dnd-app/commit/2e28b9f4) v3.95.1: chore(perf): ленивый character-builds.js и esc() через escapeHtml
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/898e9aa0...0ec66fb5) · 14 файлов, +568 −660

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`0ec66fb5`](https://github.com/D1MANYCH/dnd-app/commit/0ec66fb5) v3.95.0: feat(style): окна-экраны — история здоровья, поиск заклинаний и справка по предметам
...
- `app-spells.js` +5 −5
- `CHANGELOG.md` +6 −1
- `history-stack.js` +2 −3
- `tests/theme-audit-fixture.html` +4 −0
...
<a id="v3.94.0"></a>
## v3.94.0 — 12 сентября 2026

✨ Повышение уровня, отдых и каталоги предметов стали экранами в языке главного меню: без оболочки модалки, возврат — «← Назад», Escape и кнопка «Назад» браузера. Сводка повышения, умения, варианты выбора, кости хитов и строки каталогов — плоские строки с ромбом, фильтры каталогов — на плоских полях, действия текстовые. Форма предмета после выбора из каталога возвращается с заполненными полями. Браузерный «Назад» с экранов «Об умении» и «Умение» больше не уводит из приложения.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/22b5f61b...898e9aa0) · 12 файлов, +717 −581

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`898e9aa0`](https://github.com/D1MANYCH/dnd-app/commit/898e9aa0) v3.94.0: feat(style): окна-экраны — повышение уровня, отдых и каталоги предметов
...
- `docs/map.md` +129 −128
- `index.html` +94 −111
- `docs/RELEASES.md` +36 −7
- `app-core.js` +24 −9
- `app-inventory.js` +13 −10
- `app-hp.js` +7 −8
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `history-stack.js` +3 −2
- `tests/theme-audit-fixture.html` +4 −0
- `sw.js` +1 −1
...
<a id="v3.93.1"></a>
## v3.93.1 — 12 сентября 2026

✨ Лист персонажа: классический режим характеристик без коробок — шесть ячеек стоят на одной волосяной линии, спасброски и навыки в аккордеонах — плоскими строками, пассивная внимательность — строкой «подпись · значение». Удалена мёртвая базовая коробка участника «Мира» (.pcard). Имя владеемого спасброска в светлой теме переведено на читаемый акцент (контраст 4.43 → 4.57).

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/a6ca31a2...22b5f61b) · 9 файлов, +352 −110

<details><summary>Коммиты и файлы</summary>

**Коммиты (2):**

- [`153e807a`](https://github.com/D1MANYCH/dnd-app/commit/153e807a) chore(tools): отчёт по записи в кеш и цена сессии в Stop-хуке
- [`22b5f61b`](https://github.com/D1MANYCH/dnd-app/commit/22b5f61b) v3.93.1: feat(style): классический режим характеристик без коробок

**Файлы (9):**

- `tools/cache-write-report.js` +203 −0
- `index.html` +46 −46
- `style.css` +29 −51
- `docs/RELEASES.md` +34 −5
- `tools/check-session-size-hook.js` +20 −2
- `data.js` +11 −3
- `CHANGELOG.md` +6 −1
- `CLAUDE.md` +2 −1
- `sw.js` +1 −1
...
<a id="v3.92.1"></a>
## v3.92.1 — 4 сентября 2026

✨ Вкладка «Мир» доведена до общего вида: у глифов участников убрана круглая подложка, из шапок пяти разделов убран ведущий значок, заголовок раздела выровнен по левому краю вкладки. Удалены перекрытые объявления карточки раздела и контурных кнопок добавления.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/6bf257b0...6095a883) · 8 файлов, +114 −102

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`6095a883`](https://github.com/D1MANYCH/dnd-app/commit/6095a883) v3.92.1: feat(style): вкладка «Мир» — глифы без подложки, шапки разделов без значка
...
<a id="v3.92.0"></a>
## v3.92.0 — 3 сентября 2026

✨ Вкладка «Бой» переоформлена в строки: карточки оружия, ресурсов класса, сбора участников и трекера без коробок, заголовки разделов на волосяной линии, ромб раздела цвета фракции, поля инициативы и хитов с нижней линией вместо рамок, кнопки трекера и чипы раунда — текстом; залитой осталась одна кнопка на экран. Убраны шесть перебивок светлой темы, светлых !important 102 → 90.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/63fb4d39...6bf257b0) · 9 файлов, +375 −246

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`6bf257b0`](https://github.com/D1MANYCH/dnd-app/commit/6bf257b0) v3.92.0: feat(style): вкладка «Бой» переоформлена в строки без коробок
...
<a id="v3.91.2"></a>
## v3.91.2 — 2 сентября 2026

✨ Шесть подклассов из «Руководства мастера» и «Путеводителя по Побережью Мечей»: Домен смерти (жрец), Путь бушующего в бою (варвар), Рыцарь Пурпурного дракона (воин), Путь долгой смерти (монах), Клятва короны (паладин), Бессмертный (колдун) — фичи по уровням, заклинания подкласса у домена смерти, клятвы короны и бессмертного, владение воинским оружием у домена смерти. Всего подклассов в приложении 106.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/8441b5ad...63fb4d39) · 6 файлов, +186 −67

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`63fb4d39`](https://github.com/D1MANYCH/dnd-app/commit/63fb4d39) v3.91.2: feat(subclasses): Шесть подклассов из «Руководства мастера» и «Путеводителя по Побережью Мечей»: Домен смерти (жрец), Путь бушующего в бою (варвар), Рыцарь Пурпурного дракона (воин), Путь долгой смерти (монах), Клятва короны (паладин), Бессмертный (колдун) — фичи по уровням, заклинания подкласса у домена смерти, клятвы короны и бессмертного, владение воинским оружием у домена смерти. Всего подклассов в приложении 106.

**Файлы (6):**

- `index.html` +46 −46
- `data.js` +67 −9
- `docs/RELEASES.md` +33 −10
- `subclass-choices-data.js` +33 −0
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/a317cf4e...8441b5ad) · 12 файлов, +755 −85
...
- [`8441b5ad`](https://github.com/D1MANYCH/dnd-app/commit/8441b5ad) v3.91.1: feat(subclasses): Девять подклассов из «Котла всякой всячины Таши»: Путь астрального Я (монах), Клятва славы (паладин), Повелитель роя (следопыт), Душеклинок (плут), Аберрантный разум и Часовая душа (чародей), Глубинный (колдун), Певец меча и Орден переписчиков (волшебник) — фичи по уровням, заклинания подкласса у клятвы славы, глубинного, аберрантного разума и часовой души, лёгкие доспехи у певца меча. Всего подклассов в приложении 100.

**Файлы (12):**

- `docs/map.md` +259 −0
- `tools/gen-map.js` +164 −0
- `data.js` +88 −10
- `index.html` +46 −46
- `docs/RELEASES.md` +56 −25
- `tools/check-session-size-hook.js` +71 −0
- `subclass-choices-data.js` +44 −0
- `CLAUDE.md` +7 −2
- `.claude/skills/verify-ui/SKILL.md` +8 −0
- `CHANGELOG.md` +6 −1
...
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `tests/theme-audit-fixture.html` +2 −3
- `app-party.js` +2 −2
- `app-ui.js` +3 −1
- `sw.js` +1 −1
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/b1253a65...235242fd) · 7 файлов, +133 −60

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`235242fd`](https://github.com/D1MANYCH/dnd-app/commit/235242fd) v3.87.0: feat(ui): фикс поповера «Записи» и кнопка печати PDF на «Данных»
...
<a id="v3.84.0"></a>
## v3.84.0 — 8 августа 2026

✨ блок хитов в правом рельсе переоформлен из коробок в строку: четыре контурные кнопки −5, −1, +1 и +5, поле ввода с рамкой и заливкой и две залитые кнопки «− Урон» и «+ Лечение» занимали весь блок — теперь это одна строка с ромбом раскрытия, пресеты 1, 5, 10 и 20 стоят в свёрнутой строке и применяют урон сразу, а поле и текстовые действия «Нанести» и «Вылечить» живут в раскрытии; строка раскрывается сама, пока текущие хиты меньше максимума, уважает ручное сворачивание до полного здоровья и при нуле хитов становится «Лечение» без пресетов — те же правила, что у раздела «Здоровье и Бой» на листе, классы пресетов, поля и действий общие с ним; полоса хитов уменьшена с капсулы 8 пикселей с закруглением до волосяной линии 2 пикселя, трёхцветный градиент заливки заменён сплошным цветом с порогами на четверти и половине; высота блока в свёрнутом виде 131 пиксель, тач-цели 44 пикселя; коробочных элементов на листе не осталось вовсе; ратчет хардкодов темы 537 и !important 102 без роста

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/b7f729d4...7e402b80) · 7 файлов, +160 −98

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`7e402b80`](https://github.com/D1MANYCH/dnd-app/commit/7e402b80) v3.84.0: feat(hp): блок хитов в правом рельсе переоформлен из коробок в строку: четыре контурные кнопки −5, −1, +1 и +5, поле ввода с рамкой и заливкой и две залитые кнопки «− Урон» и «+ Лечение» занимали весь блок — теперь это одна строка с ромбом раскрытия, пресеты 1, 5, 10 и 20 стоят в свёрнутой строке и применяют урон сразу, а поле и текстовые действия «Нанести» и «Вылечить» живут в раскрытии; строка раскрывается сама, пока текущие хиты меньше максимума, уважает ручное сворачивание до полного здоровья и при нуле хитов становится «Лечение» без пресетов — те же правила, что у раздела «Здоровье и Бой» на листе, классы пресетов, поля и действий общие с ним; полоса хитов уменьшена с капсулы 8 пикселей с закруглением до волосяной линии 2 пикселя, трёхцветный градиент заливки заменён сплошным цветом с порогами на четверти и половине; высота блока в свёрнутом виде 131 пиксель, тач-цели 44 пикселя; коробочных элементов на листе не осталось вовсе; ратчет хардкодов темы 537 и !important 102 без роста

**Файлы (7):**

- `index.html` +45 −45
- `app-desktop.js` +48 −12
- `style.css` +20 −32
- `docs/RELEASES.md` +30 −5
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
...
<a id="v3.80.0"></a>
## v3.80.0 — 8 августа 2026

✨ у строк, которые раскрываются, появился общий знак — ромб с закрашенной правой половиной, при раскрытии заливка уходит вниз одним поворотом на 90 градусов; знак заменил разнобой из «▶/▼» в сумке и заклинаниях, «▸/▾» в секциях подготовки боя, надписи «Подробнее» у состояний и «▾» у шапки характеристик, а в правом рельсе и записях полная заливка ромба уступила половинной — целиком закрашенный ромб теперь значит только потраченную ячейку заклинания; в сумке строка вещи носила два ромба сразу (категорийный слева и знак раскрытия справа) — остался один, категорийный, полузакрашенный в цвет категории; поворот ромба на наведении снят, он читался как «уже раскрыто»; у каждой характеристики в раскрытии появилось действие «О характеристике» — отдельный экран с описанием по «Книге Игрока» 2014 (стр. 175–179): что характеристика измеряет, что моделируют её проверки, от чего защищает спасбросок, за что она отвечает помимо проверок, плюс список своих навыков и текущее значение персонажа; в справке добавлен раздел «Условные знаки» с живыми ромбами, в тур по листу — шаг про знак раскрытия; нативные выпадающие списки знака не получают, у них остаётся системный шеврон.

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/3434da9a...6b4895ae) · 14 файлов, +927 −112

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`6b4895ae`](https://github.com/D1MANYCH/dnd-app/commit/6b4895ae) v3.80.0: feat(ui): единый ромб-знак раскрытия во всех вкладках + экран «О характеристике»

**Файлы (14):**

- `tests/style-disclosure-mockups.html` +300 −0
- `tests/style-8r2-mockups.html` +263 −0
- `style.css` +138 −47
- `index.html` +83 −46
- `data.js` +54 −3
- `docs/RELEASES.md` +36 −5
...
- `index.html` +69 −69
- `docs/RELEASES.md` +33 −5
- `app-inventory.js` +7 −9
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `.github/workflows/tests.yml` +5 −1
- `sw.js` +1 −1

</details>

<a id="v3.78.2"></a>
## v3.78.2 — 7 августа 2026

🐛 цвета школ заклинаний переведены на токены тем: в светлой теме подписи школ на бейджах давали контраст 1.24–2.23 и практически не читались (некромантия 1.34), теперь 5.13–5.17 при сохранённых оттенках, тёмная тема не изменилась; заливки меток источника PH14 и PH24 затемнены под белый текст до 4.6 (было 2.96 и 3.20); восемь школ поставлены под автопроверку контраста в CI, пар стало 118; ратчет хардкодов 608 → 584

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/2582177d...e580f944) · 8 файлов, +152 −74

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`e580f944`](https://github.com/D1MANYCH/dnd-app/commit/e580f944) v3.78.2: fix(theme): цвета школ заклинаний переведены на токены тем: в светлой теме подписи школ на бейджах давали контраст 1.24–2.23 и практически не читались (некромантия 1.34), теперь 5.13–5.17 при сохранённых оттенках, тёмная тема не изменилась; заливки меток источника PH14 и PH24 затемнены под белый текст до 4.6 (было 2.96 и 3.20); восемь школ поставлены под автопроверку контраста в CI, пар стало 118; ратчет хардкодов 608 → 584
...
- `docs/RELEASES.md` +30 −5
- `data.js` +10 −2
- `tools/theme-contrast-pairs.json` +10 −0
- `CHANGELOG.md` +6 −1
- `tools/theme-baseline.json` +2 −2
- `sw.js` +1 −1
...
<a id="v3.78.1"></a>
## v3.78.1 — 7 августа 2026

🐛 в светлой теме снова видны подпись кнопки «Сохранить и зафиксировать основу» и номер шага в баннере создания персонажа: перебивки старого коробочного оформления красили их белым поверх светлого фона (контраст 1.15), теперь оба узла берут цвет плоского рецепта — 6.39 в светлой теме и 4.95 в тёмной, у неактивной кнопки убрана заливка

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/40553edb...2582177d) · 7 файлов, +111 −60

<details><summary>Коммиты и файлы</summary>

**Коммиты (3):**

- [`92f65091`](https://github.com/D1MANYCH/dnd-app/commit/92f65091) chore(ci): перезапуск CI после v3.78.0
- [`45e1454a`](https://github.com/D1MANYCH/dnd-app/commit/45e1454a) chore(ci): страховка деплоя pages — уникальное имя артефакта и таймаут очереди
- [`2582177d`](https://github.com/D1MANYCH/dnd-app/commit/2582177d) v3.78.1: fix(ui): в светлой теме снова видны подпись кнопки «Сохранить и зафиксировать основу» и номер шага в баннере создания персонажа: перебивки старого коробочного оформления красили их белым поверх светлого фона (контраст 1.15), теперь оба узла берут цвет плоского рецепта — 6.39 в светлой теме и 4.95 в тёмной, у неактивной кнопки убрана заливка

**Файлы (7):**

- `index.html` +45 −45
- `docs/RELEASES.md` +30 −4
- `data.js` +11 −3
- `.github/workflows/pages.yml` +12 −0
- `style.css` +6 −6
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
...
<a id="v3.75.1"></a>
## v3.75.1 — 6 августа 2026

🐛 плоский текст интерфейса (кнопки без заливки, строки меню, фильтры) держался на токене --accent-lo, контраст которого не проверялся ни одним чеком: в светлой теме с золотым акцентом он давал 4.36 при норме WCAG AA 4.5, а в тёмной — 3.76 у графита, 3.77 у рубина, 3.89 у аметиста, 3.94 у меди, 4.37 у изумруда и 4.47 у сапфира; семь значений подняты до 4.60 подбором по худшему из трёх фонов (--bg-0, --bg-1, --home-plate); check-theme.js получил раздел accentPairs — такие пары теперь гоняются по всем восьми пресетам акцента в обеих темах, проверяемых пар 48 → 102; крестик закрытия обучающего тура переведён с × на ✕ вслед за остальными 33; фикстура аудита тем чинена — после того как гайд билда стал экраном, она садилась на него и любой снимок вкладки показывал гайд вместо запрошенного, добавлены параметры &accent= (фиксирует пресет вместо авто-акцента по классу героя) и &screen=home

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/45b0d06b...ac40aa85) · 10 файлов, +164 −70

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`ac40aa85`](https://github.com/D1MANYCH/dnd-app/commit/ac40aa85) v3.75.1: fix(theme): контраст --accent-lo по WCAG AA во всех пресетах акцента, accentPairs в check-theme.js, крестик тура ✕, фикс фикстуры аудита тем (&accent=, &screen=home)
...
- `docs/RELEASES.md` +33 −5
- `style.css` +13 −12
- `tests/theme-audit-fixture.html` +20 −1
- `tools/check-theme.js` +21 −0
- `data.js` +11 −3
- `tools/theme-contrast-pairs.json` +13 −1
- `CHANGELOG.md` +6 −1
- `app-help.js` +1 −1
- `sw.js` +1 −1
...
- `app-core.js` +25 −3
- `data.js` +10 −2
- `tests/theme-audit-fixture.html` +4 −5
- `CHANGELOG.md` +6 −1
- `history-stack.js` +3 −1
- `tools/theme-baseline.json` +2 −2
- `sw.js` +1 −1
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/1a7962c2...1df36f27) · 10 файлов, +288 −110

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`1df36f27`](https://github.com/D1MANYCH/dnd-app/commit/1df36f27) v3.72.0: feat(ui): вкладка «Журнал» в языке встречающего экрана — карточка-обёртка и записи лишились коробок: тип события кодирует залитый ромб вместо цветной полосы слева, дата и уровень встали значением справа строки, между записями волосяной разделитель; «＋ Событие» и шесть фильтров стали текстовыми подписями с растущим подчёркиванием, активный фильтр без заливки и без рамки; на экранах уже 560px дата уходит под заголовок, иначе название рвалось на три строки; девять цветов типов записей сведены к токенам, ратчет хардкодов 713 → 712
...
- `index.html` +45 −45
- `docs/RELEASES.md` +33 −5
- `tests/theme-audit-fixture.html` +21 −0
- `app-ui.js` +9 −4
- `data.js` +10 −2
...
<a id="v3.71.0"></a>
## v3.71.0 — 2 августа 2026

✨ переходы между экранами: уходящий экран улетает в сторону, входящий приезжает навстречу — вперёд (меню → выбор персонажа → лист) влево/справа, кнопка «←» и браузерный Back зеркально; уходящий экран на время полёта фиксируется по своим прежним координатам, чтобы не толкать входящий; модалки меню «Данные», «Настройки» и «О версии» въезжают справа как под-меню, само меню отъезжает влево и притухает; при системной настройке «меньше движения» переходы не проигрываются

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/3a3ea054...1a7962c2) · 9 файлов, +257 −60

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`1a7962c2`](https://github.com/D1MANYCH/dnd-app/commit/1a7962c2) v3.71.0: feat(ui): переходы между экранами: уходящий экран улетает в сторону, входящий приезжает навстречу — вперёд (меню → выбор персонажа → лист) влево/вправо, кнопка «←» и браузерный Back зеркально; уходящий экран на время полёта фиксируется по своим прежним координатам, чтобы не толкать входящий; модалки меню «Данные», «Настройки» и «О версии» въезжают справа как под-меню, само меню отъезжает влево и притухает; при системной настройке «меньше движения» переходы не проигрываются
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/c8be4043...3a3ea054) · 9 файлов, +654 −212

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`3a3ea054`](https://github.com/D1MANYCH/dnd-app/commit/3a3ea054) v3.70.0: feat(ui): вкладка «Записи» в языке встречающего экрана — секции предыстории и записи стали плоскими строками без карточек: ромб-маркер вместо шеврона и цветной полосы, закреплённая запись помечена залитым ромбом, значение «N симв.» справа, теги текстом через точку-разделитель; под-табы и MD-тулбар потеряли коробки и получили растущее подчёркивание, поля ввода облегчены, добавлен каскад появления; крупные ромб-марки у имени героя на встречающем экране и в шапке бокового меню сняты; 12 светлых перебивок !important удалены, ратчет хардкодов 815 → 713, !important светлой темы 156 → 137
