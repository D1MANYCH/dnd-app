...
<a id="v3.70.0"></a>
## v3.70.0 — 2 августа 2026

✨ вкладка «Записи» в языке встречающего экрана — секции предыстории и записи стали плоскими строками без карточек: ромб-маркер вместо шеврона и цветной полосы, закреплённая запись помечена залитым ромбом, значение «N симв.» справа, теги текстом через точку-разделитель; под-табы и MD-тулбар потеряли коробки и получили растущее подчёркивание, поля ввода облегчены, добавлен каскад появления; крупные ромб-марки у имени героя на встречающем экране и в шапке бокового меню сняты; 12 светлых перебивок !important удалены, ратчет хардкодов 815 → 713, !important светлой темы 156 → 137

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/c8be4043...main) · 8 файлов, +622 −207
...
- `style.css` +535 −151
- `index.html` +45 −47
- `tests/theme-audit-fixture.html` +18 −0
- `data.js` +10 −2
- `app-notes.js` +5 −3
- `CHANGELOG.md` +6 −1
...
<a id="v3.69.0"></a>
## v3.69.0 — 2 августа 2026

✨ правый rail в языке встречающего экрана — всегда видны хиты и бросок d20, остальное четыре плоские строки-сводки со значением справа: класс доспеха, уровень, ячейки, состояния; строки раскрываются на месте (кубики d4–d12, полоски ячеек по кругам, бейджи состояний), пять карточек-коробок и мини-чипы КД/уровня/вдохновения сняты, вдохновение стало ромбом строки «Уровень», добавлены ромб-маркер, растущее подчёркивание и каскад появления как в боковом меню; ратчет хардкодов 819 → 815

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/918f4181...c8be4043) · 8 файлов, +362 −154

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`c8be4043`](https://github.com/D1MANYCH/dnd-app/commit/c8be4043) v3.69.0: feat(ui): правый rail в языке встречающего экрана — всегда видны хиты и бросок d20, остальное четыре плоские строки-сводки со значением справа: класс доспеха, уровень, ячейки, состояния; строки раскрываются на месте (кубики d4–d12, полоски ячеек по кругам, бейджи состояний), пять карточек-коробок и мини-чипы КД/уровня/вдохновения сняты, вдохновение стало ромбом строки «Уровень», добавлены ромб-маркер, растущее подчёркивание и каскад появления как в боковом меню; ратчет хардкодов 819 → 815

**Файлы (8):**

- `style.css` +180 −59
- `app-desktop.js` +88 −40
- `index.html` +45 −45
- `docs/RELEASES.md` +31 −5
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
...
<a id="v3.68.0"></a>
## v3.68.0 — 2 августа 2026

✨ боковое меню в языке встречающего экрана — плоские строки без коробок: ромб-маркер, подпись serif и растущее подчёркивание, группы «Персонаж» / «Кампания» / «Сервис» вместо разделителей, шапка с ромбом и подзаголовком «класс · раса», кнопка настроек без рамки; активный пункт на --accent-lo без подложки (контраст 4.19 → 4.74), высота строки 44px, снят 31 !important; имя персонажа в сайдбаре больше не застревает на «Персонаж» на ПК

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/97724aaf...918f4181) · 8 файлов, +283 −154

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`918f4181`](https://github.com/D1MANYCH/dnd-app/commit/918f4181) v3.68.0: feat(ui): боковое меню в языке встречающего экрана — плоские строки без коробок: ромб-маркер, подпись serif и растущее подчёркивание, группы «Персонаж» / «Кампания» / «Сервис» вместо разделителей, шапка с ромбом и подзаголовком «класс · раса», кнопка настроек без рамки; активный пункт на --accent-lo без подложки (контраст 4.19 → 4.74), высота строки 44px, снят 31 !important; имя персонажа в сайдбаре больше не застревает на «Персонаж» на ПК
...
<a id="v3.67.0"></a>
## v3.67.0 — 1 августа 2026

✨ вкладка «Мир» в языке встречающего экрана — разделы и участники стали плоскими строками без карточек и рамок, чипы сведены к тексту через точку-разделитель, тип участника отмечает ромб вместо цветной полосы; на экране от 1100px участники раскладываются в колонки, шапка «Мой персонаж» от 700px разворачивается в строку; текстовые действия переведены на --accent-lo, контраст в светлой теме 3.55 → 5.03; цветовые хардкоды вкладки сведены к токенам

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/c51ee90f...97724aaf) · 11 файлов, +394 −120

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`97724aaf`](https://github.com/D1MANYCH/dnd-app/commit/97724aaf) v3.67.0: feat(ui): вкладка «Мир» — плоские строки без карточек и рамок, чипы через точку-разделитель, ромб вместо цветной полосы, колонки от 1100px, строка «Мой персонаж» от 700px, действия на --accent-lo (контраст 3.55 → 5.03), хардкоды на токены
...
- `app-party.js` +10 −8
- `tests/theme-audit-fixture.html` +17 −0
- `data.js` +11 −3
...
<a id="v3.66.0"></a>
## v3.66.0 — 31 июля 2026

✨ единый вид вкладки «Бой» — строки сбора участников, секции и строки трекера на общую подложку, чипы раунда и повторных тиков без заливки, контурная навигация хода, цвета урона/лечения и инициативы на токены темы, каскад появления; заголовки секций сбора больше не теряют контраст в светлой теме

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/7084083d...c51ee90f) · 9 файлов, +180 −92

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`c51ee90f`](https://github.com/D1MANYCH/dnd-app/commit/c51ee90f) v3.66.0: feat(ui): единый вид вкладки «Бой» — строки сбора участников, секции и строки трекера на общую подложку, чипы раунда и повторных тиков без заливки, контурная навигация хода, цвета урона/лечения и инициативы на токены темы, каскад появления; заголовки секций сбора больше не теряют контраст в светлой теме

**Файлы (9):**

- `style.css` +71 −33
- `index.html` +45 −45
- `docs/RELEASES.md` +32 −5
- `data.js` +10 −2
- `app-party.js` +7 −4
- `.claude/launch.json` +7 −0
- `CHANGELOG.md` +6 −1
...
<a id="v3.65.0"></a>
## v3.65.0 — 31 июля 2026

✨ единый вид вкладки «Сумка» — вложенные блоки на общую подложку, плоские чипы и контурные фильтры, цвета настройки и зарядов на токены темы, каскад появления; в светлой теме крупная цифра монеты больше не обрамляется рамкой

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/fc927aca...7084083d) · 7 файлов, +185 −121

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`7084083d`](https://github.com/D1MANYCH/dnd-app/commit/7084083d) v3.65.0: feat(ui): единый вид вкладки «Сумка» — вложенные блоки на общую подложку, плоские чипы и контурные фильтры, цвета настройки и зарядов на токены темы, каскад появления; в светлой теме крупная цифра монеты больше не обрамляется рамкой

**Файлы (7):**

- `style.css` +92 −66
- `index.html` +45 −45
- `docs/RELEASES.md` +30 −5
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
- `tools/theme-baseline.json` +1 −1
...
<a id="v3.64.0"></a>
## v3.64.0 — 31 июля 2026

✨ единый вид вкладки «Заклинания» — вложенные блоки на общую подложку, заголовки уровней плоскими строками, цвета концентрации и ритуала на токен темы, каскад появления

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/26dec929...fc927aca) · 7 файлов, +204 −150

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`fc927aca`](https://github.com/D1MANYCH/dnd-app/commit/fc927aca) v3.64.0: feat(ui): единый вид вкладки «Заклинания» — вложенные блоки на общую подложку, заголовки уровней плоскими строками, цвета концентрации и ритуала на токен темы, каскад появления
...
<a id="v3.63.1"></a>
## v3.63.1 — 31 июля 2026

🐛 Характеристики на телефоне: строки спасбросков и навыков внутри карточки больше не растягивают страницу по горизонтали (вылет 49px на 375px, 18px на 320px)

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/34ae65cd...26dec929) · 6 файлов, +110 −55

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`26dec929`](https://github.com/D1MANYCH/dnd-app/commit/26dec929) v3.63.1: fix(style): характеристики на телефоне — строки спасбросков и навыков внутри карточки больше не растягивают страницу по горизонтали (вылет 49px на 375px, 18px на 320px)

**Файлы (6):**

- `index.html` +45 −45
- `docs/RELEASES.md` +28 −5
- `style.css` +20 −1
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
...
<a id="v3.63.0"></a>
## v3.63.0 — 31 июля 2026

✨ Вкладка «Лист» приведена к общему виду: блок «Класс Доспеха» и четыре свёрнутых раздела стали такими же карточками, как соседние, вложенные коробки внутри карточек заменены плоскими строками с тонкими разделителями — во «Владениях» их было три одна в другой; панели «Урон» и «Лечение» больше не залиты цветом, у них остался только контур; при переходе на вкладку блоки появляются каскадом

🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/bc5cd99a...34ae65cd) · 8 файлов, +211 −137

<details><summary>Коммиты и файлы</summary>

**Коммиты (2):**

- [`4d65ead1`](https://github.com/D1MANYCH/dnd-app/commit/4d65ead1) chore(dev): скилл release описывает ожидание CI и обязательный пост-анонс
- [`34ae65cd`](https://github.com/D1MANYCH/dnd-app/commit/34ae65cd) v3.63.0: feat(ui): единый вид вкладки «Лист» — карточки, плоские строки, каскад

**Файлы (8):**

- `style.css` +104 −79
- `index.html` +45 −45
- `docs/RELEASES.md` +33 −5
- `.claude/skills/release/SKILL.md` +11 −3
- `data.js` +10 −2
- `CHANGELOG.md` +6 −1
- `sw.js` +1 −1
- `tools/theme-baseline.json` +1 −1
...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/d0a3340f...bc5cd99a) · 26 файлов, +722 −545

<details><summary>Коммиты и файлы</summary>

**Коммиты (1):**

- [`bc5cd99a`](https://github.com/D1MANYCH/dnd-app/commit/bc5cd99a) v3.62.0: feat(ui): SVG-иконки вместо эмодзи в хроме и спокойная палитра кнопок
