...
🔍 [Полный патч](https://github.com/D1MANYCH/dnd-app/compare/a6ca31a2...main) · 8 файлов, +543 −108
...
- `tools/cache-write-report.js` +406 −0
- `index.html` +46 −46
- `style.css` +29 −51
- `tools/check-session-size-hook.js` +40 −4
- `data.js` +11 −3
- `CHANGELOG.md` +6 −1
- `CLAUDE.md` +4 −2
- `sw.js` +1 −1
