...
## 4. PWA-каталоги — по желанию, по 5 минут

- **Appscope** — https://appsco.pe/ (добавление PWA по URL).
- **store.app** и прочие PWA-директории — submit ссылки приложения.

Низкий приоритет (трафика мало), но бесплатно и быстро. Манифест уже с реальными скриншотами (v3.28.64) — листинг будет выглядеть прилично.
